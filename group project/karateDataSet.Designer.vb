...
Namespace karateDataSetTableAdapters
    ...
    Partial Public Class MembersTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1).CommandText = "SELECT ID, Last_Name, First_Name, Phone, Date_Joined"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM dbo.Members"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE (Da"& _ 
                "te_Joined < @date)"
        ...
        Public Overloads Overridable Function FilterDate(ByVal dataTable As karateDataSet.MembersDataTable, ByVal _date As Global.System.Nullable(Of Date)) As Integer
